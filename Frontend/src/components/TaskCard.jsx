...
const preview = data.description
 ...
 const isOverdue = due && due < today && data.status !== "Completed";

  return (
    <>
    <div data-aos="fade-right" >
      <div className=" w-full flex flex-col lg:min-h-[270px] bg-white rounded shadow-md py-2 px-3 lg:py-3 lg:px-4 transform transition-all duration-[390ms] ease-in-out  hover:-translate-y-1 border border-zinc-300 hover:shadow-lg hover:shadow-indigo-100 hover:scale-[1.02]">
       ...
       {previewText && ( 
        <p className="font-normal text-xs lg:text-lg text-zinc-400 py-2 bg-gray-100 rounded-2xl px-3 mb-2 max-h-20 md:max-h-24 overflow-hidden whitespace-pre-line"> 
          {previewText}
      </p>)}
