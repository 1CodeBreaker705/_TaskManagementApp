 ...
 const isOverdue = due && due < today && data.status !== "Completed";
  ...
  return (
    ...
    <div data-aos="fade-right" >
      <div className=" w-full flex flex-col lg:min-h-[270px] bg-white rounded shadow-md py-2 px-3 lg:py-3 lg:px-4 transform transition-all duration-[390ms] ease-in-out hover:scale-105 hover:shadow-xs hover:-translate-y-1 border hover:shadow-indigo-300  border-gray-300 hover:border-indigo-700"  >
