      ...
      <div className="fixed inset-0 bg-black/45 backdrop-blur-[4px] z-10" />
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="w-full max-w-[95vw] md:max-w-2xl rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-400 border border-white/20 shadow-2xl p-2 md:p-3 backdrop-blur-xl duration-300 ease-out data-closed:scale-95 data-closed:opacity-0"
            >
