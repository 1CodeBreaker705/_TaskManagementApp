      ...
      <div className="fixed inset-0 bg-black/45 backdrop-blur-[4px] z-10" />
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="w-full max-w-[95vw] md:max-w-2xl rounded-2xl bg-indigo-500 border border-white/20 shadow-2xl p-3 md:p-4 backdrop-blur-xl duration-300 ease-out data-closed:scale-95 data-closed:opacity-0"
            >
