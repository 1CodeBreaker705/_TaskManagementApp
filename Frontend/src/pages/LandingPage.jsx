    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-indigo-600 text-white flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-20">
        <div className="lg:w-1/2">
          ...
          <p className="mb-6 text-lg lg:text-xl text-indigo-100">
            Taskin simplifies professional and personal daily task management with rich text support, a clean modern UI, personal dashboard and smart features.
          </p>
      ...
      <section className="bg-gray-50 text-gray-800 py-20 px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded shadow p-6 flex flex-col items-center text-center hover:scale-105 transform transition">
            ...
            <h3 className="font-semibold text-xl mb-2">Analytics and Calendar</h3>
            <p>Keep track of all your tasks. Never miss any deadline with dedicated analytics page which tracks total tasks, overdue tasks, provides category-wise and priority-wise task tracking, Calendar page to organize and track your important days.
            </p>
          </div>
          <div className="bg-white rounded shadow p-6 flex flex-col items-center text-center hover:scale-105 transform transition">
